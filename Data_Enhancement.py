    ...
    for img_name in img_names:
        ...
        if os.path.isdir(tmp_img_name):
            ...
            for ops_name in opsList:
                threadImage[index] = threading.Thread(target=imageOps, args=(ops_name, image, new_path, img_name,))
                threadImage[index].start()
                index += 1
                time.sleep(0.2)


if __name__ == '__main__':
    threadOPS(r"shuju-bi/jzxc", r"E:\FFOutput\shiju\output\jzxc")
